...
(function (SamerCs) {
    ...
    })(Administration = SamerCs.Administration || (SamerCs.Administration = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Administration;
...
(function (SamerCs) {
    ...
    })(BasicSamples = SamerCs.BasicSamples || (SamerCs.BasicSamples = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SamerCs.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SamerCs.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SamerCs.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SamerCs) {
    ...
    })(Common = SamerCs.Common || (SamerCs.Common = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Common;
...
(function (SamerCs) {
    ...
    })(Membership = SamerCs.Membership || (SamerCs.Membership = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Membership;
...
(function (SamerCs) {
    ...
    })(Northwind = SamerCs.Northwind || (SamerCs.Northwind = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Northwind;
...
(function (SamerCs) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'SamerCs.Northwind.Gender', 'SamerCs.Northwind.Entities.Gender');
    })(Northwind = SamerCs.Northwind || (SamerCs.Northwind = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
...
(function (SamerCs) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'SamerCs.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = SamerCs.Northwind || (SamerCs.Northwind = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
...
(function (SamerCs) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SamerCs.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SamerCs.LanguageList || (SamerCs.LanguageList = {}));
})(SamerCs || (SamerCs = {}));
...
(function (SamerCs) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('SamerCs');
        Serenity.EntityDialog.defaultLanguageList = SamerCs.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SamerCs.ScriptInitialization || (SamerCs.ScriptInitialization = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Administration;
...
(function (SamerCs) {
    ...
    SamerCs.BasicProgressDialog = BasicProgressDialog;
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SamerCs.BasicProgressDialog();
...
(function (SamerCs) {
    ...
    })(DialogUtils = SamerCs.DialogUtils || (SamerCs.DialogUtils = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Common;
...
(function (SamerCs) {
    ...
    SamerCs.StaticTextBlock = StaticTextBlock;
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SamerCs.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(SamerCs.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(SamerCs.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SamerCs.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SamerCs.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SamerCs.Authorization.userDefinition.DisplayName,
...
(function (SamerCs) {
    ...
    (function (Northwind) {
        ...
        }(SamerCs.Common.GridEditorDialog));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return SamerCs.LanguageList.getValue();
            };
...
(function (SamerCs) {
    ...
    })(Authorization = SamerCs.Authorization || (SamerCs.Authorization = {}));
})(SamerCs || (SamerCs = {}));
var SamerCs;
(function (SamerCs) {
    var BasicSamples;
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        }(SamerCs.Northwind.ProductDialog));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SamerCs.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SamerCs.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SamerCs.Northwind.OrderDialog();
                        ...
                        var chai = SamerCs.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SamerCs.Northwind.EmployeeRow.getLookup().items
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SamerCs.Northwind.CategoryService.Retrieve({
        ...
        }(SamerCs.Northwind.CategoryDialog));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        }(SamerCs.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SamerCs.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SamerCs.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SamerCs.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SamerCs.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SamerCs.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SamerCs.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SamerCs.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SamerCs.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SamerCs.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SamerCs.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SamerCs.Northwind.OrderService.baseUrl; };
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        }(SamerCs.Northwind.SupplierDialog));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SamerCs.Northwind.SupplierGrid));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SamerCs.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SamerCs.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SamerCs.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SamerCs.Northwind.OrderService.baseUrl; };
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SamerCs.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SamerCs.Northwind.CustomerDialog));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        }(SamerCs.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = SamerCs.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SamerCs.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SamerCs.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SamerCs.Northwind.OrderDetailDialog));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        }(SamerCs.Northwind.OrderDetailsEditor));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SamerCs.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SamerCs.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SamerCs.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SamerCs.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        ...
        }(SamerCs.Common.BulkServiceAction));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SamerCs.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SamerCs.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SamerCs.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SamerCs.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SamerCs.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SamerCs.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SamerCs.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SamerCs) {
    ...
    SamerCs.SelectableEntityGrid = SelectableEntityGrid;
})(SamerCs || (SamerCs = {}));
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SamerCs.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SamerCs.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SamerCs.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SamerCs.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SamerCs.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SamerCs.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SamerCs.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SamerCs.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SamerCs.Northwind.ProductService.baseUrl; };
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SamerCs.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SamerCs.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SamerCs.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SamerCs.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SamerCs) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SamerCs.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SamerCs.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SamerCs.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=SamerCs.Web.js.map